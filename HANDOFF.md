...
- Health notes (today): old molar toothache (Panadol bought; dentist = summer, not today).
  ...
  (no food/coffee 30 min around it) when correcting starts. On Wegovy 1mg → pears 🍐 +
  Motelium for nausea. Plenty of water.
...
## How to resume
He's starting a NEW chat. First action: greet him, confirm he made it through the exam,
then ask "Ready to start Q1?" and begin the check-in partner role.
